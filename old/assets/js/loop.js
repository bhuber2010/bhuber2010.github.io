		...
		callbacks: {
			...
			elementParse: function(item) {
				...
				if (item.type === "inline") {
					...
					var html = `<h3>${item.customData.title}</h3><p>${item.customData.desc}</p><a class="btn btn-link" target="_blank" href="${item.customData.liveSite}">Live Site</a>`
					item.src.append(html)
				}
